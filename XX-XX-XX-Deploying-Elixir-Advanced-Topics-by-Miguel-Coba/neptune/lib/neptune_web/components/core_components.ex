defmodule NeptuneWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(NeptuneWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(NeptuneWeb.Gettext, "errors", msg, opts)
    end
  end
